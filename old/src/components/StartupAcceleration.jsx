...
const StartupAcceleration = () => {
  const offers = [
    {
      icon: <div className="w-8 h-8 bg-gradient-to-br from-primary-blue to-red-400 rounded-full"></div>,
    ...
    {
      icon: <div className="w-8 h-8 bg-gradient-to-br from-primary-blue to-purple-400 rounded-lg"></div>,
    ...
    {
      icon: <div className="w-8 h-8 bg-gradient-to-br from-primary-blue to-blue-400 rounded-full"></div>,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-6">
            ...
            <span className="text-primary-blue">Startup</span>
          </h2>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          <div>
            <p className="text-lg text-gray-300 leading-relaxed mb-6">
              Oferecemos muito mais que apenas <span className="text-primary-blue font-semibold">investimento financeiro</span>. 
              ...
              <span className="text-primary-blue font-semibold"> caso de sucesso</span>.
            </p>

            <p className="text-lg text-gray-300 leading-relaxed mb-8">
              Trabalhamos lado a lado com <span className="text-primary-blue font-semibold">empreendedores visionários</span>, 
              fornecendo todo o suporte necessário para escalar negócios inovadores.
            </p>

            <div className="bg-primary-blue/10 p-6 rounded-xl border border-primary-blue/20">
              <p className="text-lg text-gray-300 leading-relaxed">
                Com um histórico comprovado de <span className="text-primary-blue font-semibold">mais de 50 startups aceleradas</span> 
                e uma <span className="text-primary-blue font-semibold">taxa de sucesso superior a 80%</span>, 
          ...
          <div className="grid grid-cols-2 gap-6">
            {stats.map((stat, index) => (
              <div key={index} className="text-center bg-gray-800 p-6 rounded-xl border border-primary-blue/20">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mb-16">
          {offers.map((offer, index) => (
            <div key={index} className="group bg-gradient-to-br from-primary-blue/10 to-primary-blue/5 p-6 rounded-xl border border-primary-blue/20 hover:border-primary-blue/40 transition-all duration-300 hover:transform hover:scale-105">
        ...
        <div className="bg-gradient-to-r from-primary-blue/10 to-primary-blue/5 rounded-2xl p-8 border border-primary-blue/30">
          ...
          <div className="grid md:grid-cols-4 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-blue/30 to-red-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-6 h-6 bg-primary-blue rounded-full"></div>
              </div>
              <h4 className="text-primary-blue font-semibold mb-2">Seleção</h4>
              <p className="text-gray-300 text-sm">Processo rigoroso de seleção das startups mais promissoras</p>
            </div>
            
            <div className="text-center">
              <div className="w-16 h-16 bg-gradient-to-br from-primary-blue/30 to-purple-400/20 rounded-full flex items-center justify-center mx-auto mb-4">
                <div className="w-6 h-6 bg-primary-blue rounded-lg"></div>
              </div>
              <h4 className="text-primary-blue font-semibold mb-2">Programa</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-primary-blue font-semibold mb-2">Investimento</h4>
            ...
            <div className="text-center">
              ...
              <h4 className="text-primary-blue font-semibold mb-2">Escala</h4>
